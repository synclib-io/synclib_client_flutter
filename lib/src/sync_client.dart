...
class SyncClient {
  ...
  // Stream controller for custom/unrecognized message types (extensibility)
  final StreamController<IgnoredMessage> _customMessageController = StreamController<IgnoredMessage>.broadcast();
  ...
  Future<void> _handleMessage(SyncMessage message) async {
    try {
      ...
      } else if (message is IgnoredMessage) {
  ...
  /// Stream of custom/unrecognized message types for extensibility.
  /// Emits IgnoredMessage instances with type and payload fields.
  Stream<IgnoredMessage> get customMessages => _customMessageController.stream;
  ...
  Future<void> dispose() async {
    ...
    await _customMessageController.close();
